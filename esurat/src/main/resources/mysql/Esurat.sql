...
CREATE TABLE Buat_Surat 
    (
     ID_Buat_Surat CHAR (10) NOT NULL , 
     Peruntukan VARCHAR (30) NOT NULL , 
     Lampiran VARCHAR (30) NOT NULL , 
     Riwayat_Surat_ID_Surat VARCHAR (30) NOT NULL , 
     Staff_NIP CHAR (20) NOT NULL 
    )
;

ALTER TABLE Buat_Surat ADD CONSTRAINT Buat_Surat_PK PRIMARY KEY (ID_Buat_Surat)
;
...
CREATE TABLE Riwayat_Admin 
    (
     ID_Riwayat_Admin CHAR (10) NOT NULL , 
     Waktu_Akses TIMESTAMP NOT NULL , 
     Surat_yang_diakses VARCHAR (30) NOT NULL , 
     Admin_ID_Pengguna CHAR (10) NOT NULL 
    )
;

ALTER TABLE Riwayat_Admin ADD CONSTRAINT Riwayat_Admin_PK PRIMARY KEY (ID_Riwayat_Admin)
;
...
ALTER TABLE Staff ADD CONSTRAINT Staff_PK PRIMARY KEY (NIP)
;
...
ALTER TABLE Buat_Surat
    ADD CONSTRAINT Buat_Surat_Riwayat_Surat_FK FOREIGN KEY
    ( 
     Riwayat_Surat_ID_Surat
    ) 
    REFERENCES Riwayat_Surat 
    ( 
     ID_Surat
    )
    ON DELETE CASCADE
...
ALTER TABLE Buat_Surat
    ADD CONSTRAINT Buat_Surat_Staff_FK FOREIGN KEY
    ( 
     Staff_NIP
    ) 
    REFERENCES Staff 
...
ALTER TABLE Riwayat_Admin
    ADD CONSTRAINT Riwayat_Admin_Admin_FK FOREIGN KEY
    ( 
     Admin_ID_Pengguna
    ) 
    REFERENCES Admin 
...
ALTER TABLE Riwayat_Surat
    ADD CONSTRAINT Riwayat_Surat_Mahasiswa_FK FOREIGN KEY
    ( 
     Mahasiswa_NIM1
    ) 
...
ALTER TABLE Staff
    ADD CONSTRAINT Staff_Staff_FK FOREIGN KEY
    ( 
     Staff_NIP
    ) 
    REFERENCES Staff 
